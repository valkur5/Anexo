...
"%IDE%" -nosplash --launcher.suppressErrors -application org.eclipse.cdt.managedbuilder.core.headlessbuild -data "C:\Users\User\Documents\pruebas" -importAll "C:\Users\User\Documents\pruebas" -build SL2_TP1y2/Debug
