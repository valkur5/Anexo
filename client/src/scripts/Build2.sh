...
# Este archivo Batch se encarga de compilar el archivo remoto de programaci�n
# Utilizando el MCUXpresso IDE

# Primero se setea una variable donde se guarda la ruta del IDE
...
@REM Ahora seteamos una variable con la ubicaci�n del IDE
